...
mass_str_arr=['12-12.3','12.3-13.1','13.1-14.0']
mh_low_arr=[10**12.+0.1,10**12.3+0.1, 10**(13.1)+0.1]
mh_high_arr=[10**12.3,10**13.1,10**14]
mh_low_pow_arr=[12,12.3,13.1]
mh_high_pow_arr=[12.3,13.1,14.0]
